...
// Represents an event in the system, extends Entity for id and createdAt
public class Event extends Entity {
    ...
    // Serializes event fields into a CSV line for file storage
    @Override
    ...
    // Reconstructs an Event object from a CSV line
    public static Event deserialize(String line) {
        ...
        try {
            ...
            e.basePrice = 0; // Default if parsing fails
        }
